def run_demo():
    ...
    yes = input()
    print("Now checking if the db is up to date.")
    check_if_db_is_updated()


    print("Now pulling the top 25 stocks per fund from db, each with: ")
    print("value($), CIK, CUSIP, nameOfIssuer, filingDate, fundName, and ") 
    print(" the the amount of shares that were bought/sold of the stock between the most recent and its previous quarter by the fund.")
    print("Press Enter to continue.")
    yes = input()
    create_temp_table = '''
    ...
    print("Now running our own formula to produce a list of the top 25 ranked stocks averaged over all funds.")
    print("Press Enter to continue.")
    yes = input()
    ...
    print("Done running formula to produce the top 25 stocks averaged across all the funds.")
    print("The list of stock tickers is: ")
    print(return_list)
    print("Press Enter to continue:")
    yes = input()

    print("Now running LSTM model on each stock ticker")
    # IMPORTS FOR LSTM
    ...
    print("completed LSTM modeling")
    print("Starting transfer to file named \"Stock_Analysis_Results.xlsx\"")
    ...
    writer.save()
    c.close()
    print("Finished Program. Please check working directory for result file \"Stock_Analysis_Results.xlsx\"")
